 ...
 *         19.04.2017.
 */
public class StaxTreasureService implements TreasureService {
    ...
    public ArrayList<Treasure> getAllTreasures() throws ServiceException {
        ...
        try {
            ...
            StaxTreasureDAO staxTreasureDAO = daoFactory.getStaxTreasureDAO();
            treasureList = staxTreasureDAO.getTreasureList();
