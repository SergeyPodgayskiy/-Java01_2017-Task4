 ...
 *         19.04.2017.
 */
public class DomTreasureService implements TreasureService {
    ...
    public ArrayList<Treasure> getAllTreasures() throws ServiceException {
        ...
        try {
            ...
            DomTreasureDAO domTreasureDAO = daoFactory.getDomTreasureDAO();
            treasureList = domTreasureDAO.getTreasureList();
